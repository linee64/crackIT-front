        ...
        >
          <header className="space-y-3">
            ...
            <p className="text-slate-500 font-medium text-lg max-w-2xl leading-relaxed">
              Отслеживайте свои достижения и динамику обучения в реальном времени.
            </p>
          </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { label: 'Прогресс обучения', value: '64%', icon: TrendingUp, color: 'text-blue-500', bg: 'bg-blue-50' },
              { label: 'Активные часы', value: '12.5ч', icon: Activity, color: 'text-orange-500', bg: 'bg-orange-50' },
              { label: 'Завершено задач', value: '24', icon: BarChart3, color: 'text-green-500', bg: 'bg-green-50' },
              { label: 'Текущий стрик', value: '5 дней', icon: Calendar, color: 'text-purple-500', bg: 'bg-purple-50' },
            ].map((stat, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 premium-glass p-8 rounded-[40px] border border-white bg-white/50 shadow-sm min-h-[400px]">
            ...
            <div className="premium-glass p-8 rounded-[40px] border border-white bg-white/50 shadow-sm flex flex-col">
              <h3 className="text-xl font-bold text-slate-800 mb-8">Распределение навыков</h3>
              <div className="flex-1 flex items-center justify-center">
                <div className="relative w-48 h-48 rounded-full border-[16px] border-slate-100 flex items-center justify-center">
                   ...
                   <PieChart size={40} className="text-primary/20" />
                   <div className="absolute text-center">
                      <div className="text-2xl font-black text-slate-800">75%</div>
                      <div className="text-[10px] font-bold text-slate-400 uppercase">Soft Skills</div>
                   </div>
                </div>
              </div>
              <div className="space-y-3 mt-8">
                 {[
                   { label: 'Технические навыки', value: 85, color: 'bg-blue-500' },
                   { label: 'Коммуникация', value: 70, color: 'bg-primary' },
                   { label: 'Адаптивность', value: 90, color: 'bg-purple-500' },
                 ].map((skill, i) => (
